...
const UploadImage = () => {
    return (
        <Fragment>
            <svg className="MuiBox-root css-olkjfu" width={"100%"} height={"130px"} viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
                <defs>
                ...
                <path fill="url(#BG)" fillRule="nonzero"
                ...
                <path fill="#FF4842" fillRule="nonzero"
                ...
                <path fill="#FF4842" fillRule="nonzero"
                    ...
                    opacity="0.05"></path>
                <path fill="#004B50" fillRule="nonzero"
                ...
                <path fill="#FFC107" fillRule="nonzero"
                ...
                <path fill="#FFC107" fillRule="nonzero"
                    d="M260.275579 145.813111L276.423079 145.813111 276.423079 161.960611 260.275579 161.960611z" opacity="0.5"
                    transform="rotate(34.64 268.35 153.887)"></path>
                <path fill="#FFC107" fillRule="nonzero"
                    d="M249.191579 161.852111L265.339079 161.852111 265.339079 177.999611 249.191579 177.999611z" opacity="0.3"
                ...
                <path fill="#FF4842" fillRule="nonzero"
                    d="M243.584192 142.473554L259.731692 142.473554 259.731692 158.621053 243.584192 158.621053z" opacity="0.5"
                    transform="rotate(16.29 251.658 150.547)"></path>
                <path fill="#FF4842" fillRule="nonzero"
                    d="M238.116192 161.182554L254.263692 161.182554 254.263692 177.330054 238.116192 177.330054z" opacity="0.3"
                ...
                <path fill="#1890FF" fillRule="nonzero"
                ...
                <path fill="#1890FF" fillRule="nonzero"
                    d="M234.234488 142.413498L250.381988 142.413498 250.381988 158.560998 234.234488 158.560998z" opacity="0.5"
                    transform="rotate(4.6 242.308 150.487)"></path>
                <path fill="#1890FF" fillRule="nonzero"
                    d="M232.672488 161.846499L248.819988 161.846499 248.819988 177.993999 232.672488 177.993999z" opacity="0.3"
                ...
                <path fill="#00A76F" fillRule="nonzero"
                ...
                <path fill="#00A76F" fillRule="nonzero"
                    d="M228.305601 143.479224L244.473301 143.479224 244.473301 159.646924 228.305601 159.646924z" opacity="0.5"
                    transform="rotate(-2.862 236.39 151.563)"></path>
                <path fill="#00A76F" fillRule="nonzero"
                    d="M228.525282 163.608968L244.672782 163.608968 244.672782 179.756468 228.525282 179.756468z" opacity="0.3"
                    transform="rotate(-2.61 236.599 171.683)"></path>
                <path fill="#F4F6F8" fillRule="nonzero"
                ...
                <ellipse cx="380.363" cy="298.487" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="8.945" ry="1.513">
                </ellipse>
                <path fill="#00A76F" fillRule="nonzero"
                ...
                <ellipse cx="390.052" cy="264.383" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="5.044" ry="1"></ellipse>
                <path fill="#00A76F" fillRule="nonzero"
                ...
                <ellipse cx="346.97" cy="270.022" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="6.09" ry="1.028">
                </ellipse>
                <rect width="51.026" height="91.312" x="303.926" y="69.211" fill="#FFF" fillRule="nonzero" rx="4.737"
                    transform="rotate(-71.99 329.44 114.867)"></rect>
                <circle cx="303.613" cy="103.507" r="9.376" fill="#00A76F" fillRule="nonzero" opacity="0.2"></circle>
                <path fill="#00A76F" fillRule="nonzero"
                    d="M344.582495 86.4883769L347.150665 86.4883769 347.150665 127.336977 344.582495 127.336977z" opacity="0.2"
                    transform="rotate(-71.99 345.867 106.913)"></path>
                <path fill="#00A76F" fillRule="nonzero"
                    d="M333.028401 99.6373982L335.596571 99.6373982 335.596571 120.445898 333.028401 120.445898z" opacity="0.2"
                    transform="rotate(-71.99 334.312 110.042)"></path>
                <path fill="#00A76F" fillRule="nonzero"
                    d="M337.109071 101.431004L339.677241 101.431004 339.677241 135.086304 337.109071 135.086304z" opacity="0.2"
                    transform="rotate(-71.99 338.393 118.259)"></path>
                <path fill="#00A76F" fillRule="nonzero"
                    d="M338.505494 105.174377L341.073664 105.174377 341.073664 146.022978 338.505494 146.022978z" opacity="0.2"
                    transform="rotate(-71.99 339.79 125.599)"></path>
                <path fill="#00A76F" fillRule="nonzero"
                    d="M348.060839 134.648161L353.026769 134.648161 353.026769 145.952261 348.060839 145.952261z" opacity="0.5"
                    transform="rotate(-71.99 350.544 140.3)"></path>
                <rect width="50.3" height="78.305" x="291.549" y="174.486" fill="#FFF" fillRule="nonzero" rx="4"
                    transform="rotate(-57.265 316.7 213.638)"></rect>
                <path fill="#DFE3E8" fillRule="nonzero"
                ...
                <path fill="#007867" fillRule="nonzero"
                    d="M269.277 168.76l-45.767.493a3.127 3.127 0 00-3.094 3.125v3.782a3.127 3.127 0 01-3.05 3.124l-33.024.792a3.124 3.124 0 01-3.095-2.308l-1.551-5.701a3.124 3.124 0 00-3.053-2.308l-44.113.475a3.125 3.125 0 00-3.05 3.648l17.747 104.449a3.129 3.129 0 003.071 2.604l139.363.598a3.129 3.129 0 003.082-3.714l-20.366-106.521a3.125 3.125 0 00-3.1-2.538z"
                    opacity="0.243"></path>
                <path fill="url(#linearGradient-2)" fillRule="nonzero"
                    d="M269.277 168.76l-45.767.493a3.127 3.127 0 00-3.094 3.125v3.782a3.127 3.127 0 01-3.05 3.124l-33.024.792a3.124 3.124 0 01-3.095-2.308l-1.551-5.701a3.124 3.124 0 00-3.053-2.308l-44.113.475a3.125 3.125 0 00-3.05 3.648l17.747 104.449a3.129 3.129 0 003.071 2.604l139.363.598a3.129 3.129 0 003.082-3.714l-20.366-106.521a3.125 3.125 0 00-3.1-2.538z"
                    opacity="0.32"></path>
                <ellipse cx="119.593" cy="258.664" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="4.846" ry="1"></ellipse>
                <ellipse cx="101.03" cy="260.545" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="4.846" ry="1"></ellipse>
                <ellipse cx="108.459" cy="265.905" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="3.444" ry="1"></ellipse>
                <ellipse cx="89.193" cy="265.433" fill="#00A76F" fillRule="nonzero" opacity="0.1" rx="3.444" ry="1"></ellipse>
                <path fill="#00A76F" fillRule="nonzero"
                ...
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5"
                ...
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M90.344 249.701L92.293 249.701"></path>
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M92.68 254.132L95.738 254.263"></path>
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M94.542 250.586L94.21 252.179"></path>
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M97.792 255.432L97.732 256.879"></path>
                <path fill="#00A76F" fillRule="nonzero"
                ...
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M111.82 249.701L109.871 249.701"></path>
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M109.485 254.132L106.426 254.263"></path>
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M107.622 250.586L107.954 252.179"></path>
                <path stroke="#004B50" strokeLinecap="round" strokeWidth="0.5" d="M104.372 255.432L104.432 256.879"></path>
                <path fill="#00A76F" fillRule="nonzero"
                ...
                <circle cx="84.467" cy="87.003" r="6.467" fill="#00A76F" fillRule="nonzero" opacity="0.1"></circle>
                <circle cx="395.425" cy="138.681" r="6.467" fill="#00A76F" fillRule="nonzero" opacity="0.1"></circle>
                <circle cx="279.178" cy="66.467" r="6.467" fill="#00A76F" fillRule="nonzero" opacity="0.1"></circle>
                <circle cx="97.4" cy="122.68" r="10.838" fill="#00A76F" fillRule="nonzero" opacity="0.1"></circle>
                <path fill="#007867" fillRule="nonzero"
