...
function PageNotFound() {
    return (
        <Fragment>
            <svg className="MuiBox-root css-algv5w" width="100%" height="100%" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
                <defs>
                ...
                <path fill="url(#BG)" fillRule="nonzero"
                    ...
                    opacity="0.2"></path>
                <image href="https://minimals.cc/assets/illustrations/characters/character_6.png" height="300" x="205" y="30">
                </image>
