...
const UploadSvg = ({ width = "20px", height = "20px" }) => {
    return (
        <Fragment>
            <svg width={width} height={height} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" className="component-iconify MuiBox-root css-1t9pz9x iconify iconify--eva" viewBox="0 0 24 24"><g id="iconifyReact13627">
                <g id="iconifyReact13628">
                    <g id="iconifyReact13629" fill="currentColor">
