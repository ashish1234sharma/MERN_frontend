...
const RequestSentIcon = () => {
    return (
        <Fragment>
            <svg className="MuiBox-root css-pp6g9h" width={'120px'} height={'120px'} fill="none" viewBox="0 0 96 97" xmlns="http://www.w3.org/2000/svg">
                <path fill="#007867"
                ...
                <defs>
                    <filter id="filter0_i_1870_134242" width="82.787" height="85.202" x="7.205" y="4.553"
