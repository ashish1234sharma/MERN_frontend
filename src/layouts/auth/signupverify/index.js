...
const SignupVerify = () => {
    ...
    const handleSubmit = (event) => {
        ...
        usersignup(LocalStorageManager.getUserInfo())
            .then((response) => {
                if (response.status === 201) {
                    ...
                    naviagte('/auth/signin', { replace: true })
                                ...
                                <OutlinedInput
                                    ...
                                    endAdornment={
                                        <InputAdornment position='end'>
                                            <Typography variant='h6' onClick={() => { naviagte('/auth/signup') }} sx={{ color: palette?.text?.success, cursor: "pointer", }}>
                                                Change
                                            </Typography>
                                        </InputAdornment>
                                    }
