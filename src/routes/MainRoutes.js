    ...
    <Fragment>
      <Navigation>
        <Routes>
          ...
          <Route path='/admin/product/checkout/detail' element={<CheckoutDetail />} />
          ...
          <Route path='/user/account/profile/update' element={<UpdateProfile />} />
          <Route path='/user/account/reset/password' element={<ResetPassword />} />
         


          <Route path='/' index={true} element={<Navigate to={'/admin/dashboard'} replace={true} index={true} />} />
          <Route path='*' index={true} element={<Navigate to={'/admin/dashboard'} replace={true} index={true} />} />
        </Routes>
      </Navigation>
    </Fragment>
